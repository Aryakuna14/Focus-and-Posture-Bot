...
:RUN_SCRIPT
cls
"C:\Users\aryas\OneDrive\Desktop\codes\angelina\angelina_env\Scripts\python.exe" "1_data_collector.py"

:PROMPT
echo.
set /p choice="Do you want to run the data collector again? (Y/N): "
