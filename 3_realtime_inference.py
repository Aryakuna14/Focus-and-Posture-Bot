...
from utils import extract_features, SerialManager, draw_hud, BAD_POSTURE_LABELS, LANDMARK_INDICES
from config import (CNN_MODEL_PATH as MODEL_PATH, SCALER_PATH, LABEL_MAP_PATH,
                    WINDOW_SIZE, ESP32_PORT, ESP32_BAUD, SERIAL_ENABLED,
